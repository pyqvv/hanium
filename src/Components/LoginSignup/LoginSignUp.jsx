    ...
    <div className='container'>
        ...
        <div className='inputs'>
            ...
            {role === 'patient' && action==="회원가입" ? (
                <div className="input">
                    ...
                    <div className='input_input'>
                        <input type="text" placeholder='000000' maxLength="6" pattern="[0-9]{6}" required/>
                        -
                        <input type="text" placeholder='0******' maxLength="1" pattern="[1-4]{1}" required/>
                    </div>
                </div>) : null}
            <div className="input">
            ...
            <div className="input">
                ...
                <div className='input_input'>
                    <input type="text" placeholder='000' maxLength="3" pattern="[0-1]{3}" required/>
                    -
                    <input type="text" placeholder='0000' maxLength="4" pattern="[0-9]{4}" required/>
                    -
                    <input type="text" placeholder='0000' maxLength="4" pattern="[0-9]{4}" required/>
                </div>
                </div> : <div></div>}
